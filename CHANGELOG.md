...
This project is the maintained fork of [`jacksenechal/scan-mcp`](https://github.com/jacksenechal/scan-mcp),
published on npm as `@dougborg/scan-mcp`. Entries below at `0.2.1` and earlier are inherited from upstream.
Versions from `0.3.0` onward are this fork's releases, generated by release-please.

## [0.3.0](https://github.com/dougborg/scan-mcp/compare/v0.2.1...v0.3.0) (2026-07-13)


### Features

* add IcaBackend and gate preflight for ICA path ([7108b39](https://github.com/dougborg/scan-mcp/commit/7108b391c368c7f344cba12d6b039fc7c8680a2c))
* add standalone Node SEA binary and repair SDK 1.29 breakage ([b39ec8a](https://github.com/dougborg/scan-mcp/commit/b39ec8af3f6da2e37604e91eda58d896e119687c))
* add Swift helper for macOS ICA scanner backend ([611f546](https://github.com/dougborg/scan-mcp/commit/611f546e9d207b62bc1dbf6411c1e50c964e43a5))
* assemble_duplex tool for simplex two-pass scanning ([fbe54d7](https://github.com/dougborg/scan-mcp/commit/fbe54d76e7f18ba229ebabec97e8d6c4b0eb8136))
* **duplex:** wire assemble_duplex to produce PDF when source format requests it ([6c1acdf](https://github.com/dougborg/scan-mcp/commit/6c1acdfb010d215c187f3dd04d5985a1981373b3))
* **helper:** add assemble-pdf subcommand; exercise script uses Vision OCR ([0bf71e2](https://github.com/dougborg/scan-mcp/commit/0bf71e2e71178bfdd60d2c44e6efae8b50a956e1))
* **jobs:** add assemble_duplex tool for simplex two-pass workflows ([69d54f0](https://github.com/dougborg/scan-mcp/commit/69d54f0ca023baee3c81496fc5a5bc746fe8d2b0))
* **manifest:** record per-page image metrics and richer job metadata ([cff8485](https://github.com/dougborg/scan-mcp/commit/cff8485908d707a6e2e9c7007bd4a3b8011ef041))
* **ocr:** recognition quality — small-text, text-layer geometry, confidence surfacing ([9f1c83e](https://github.com/dougborg/scan-mcp/commit/9f1c83e38d12a783ee5a455b128eaa5f5af389e1))
* **ocr:** recognition-quality pass + per-page confidence surfacing ([1651a36](https://github.com/dougborg/scan-mcp/commit/1651a36a4719d9c83309f767d6076bb5179eeaa1)), closes [#18](https://github.com/dougborg/scan-mcp/issues/18)
* **ocr:** surface per-page OCR confidence in the duplex manifest ([aa8b536](https://github.com/dougborg/scan-mcp/commit/aa8b5367ed5ca9617fa8b7c02b0fba1d06e4b2b4)), closes [#18](https://github.com/dougborg/scan-mcp/issues/18)
* standalone SEA binary + richer scan manifest (repair SDK 1.29) ([5c66cf2](https://github.com/dougborg/scan-mcp/commit/5c66cf24821c3bb63685705a60f435e41c32a25d))


### Bug Fixes

* embed Info.plist and ad-hoc sign for macOS Local Network TCC ([8482768](https://github.com/dougborg/scan-mcp/commit/84827684587a10d2e5563f55774e15afee97d288))
* enumerate per-functional-unit options on multifunction scanners ([#3](https://github.com/dougborg/scan-mcp/issues/3)) ([a5f4875](https://github.com/dougborg/scan-mcp/commit/a5f48750ad8ee5da525264e757b071f28d1b7f26))
* get end-to-end scanning working — five layers of icdd gating ([f2cdde6](https://github.com/dougborg/scan-mcp/commit/f2cdde6fa046ce7ca051509b07ac57d3eb2e37a2))
* **ocr:** silence Swift 6 captured-var warning in parallel OCR pass ([b998e70](https://github.com/dougborg/scan-mcp/commit/b998e707d0f4d6a4850ddb96d317f5937e3ebcc7))
* retain scan controllers + add --verbose mode ([bb724db](https://github.com/dougborg/scan-mcp/commit/bb724db96fddfcc81dac13480b4ff7c3e6344a36))


### Performance Improvements

* **ocr:** parallelize per-page Vision OCR in SearchablePDF.assemble ([38f2927](https://github.com/dougborg/scan-mcp/commit/38f2927d1397342ef56082d53158e9c7875519f9))
* **ocr:** parallelize per-page Vision OCR in SearchablePDF.assemble ([3f4eda6](https://github.com/dougborg/scan-mcp/commit/3f4eda6930e71f8760a1726538c00303af746160)), closes [#2](https://github.com/dougborg/scan-mcp/issues/2)

## [Unreleased]

The upcoming `0.3.0` is the first release of the maintained fork. It bundles the fork's accumulated
work and a foundation pass:

### Features

- macOS / ImageCaptureCore (ICA) backend via a bundled, signed-and-notarized native helper — capture without SANE on macOS.
- `assemble_duplex` tool — interleave two simplex passes (fronts + flipped backs) into one duplex document.
- `pdf-searchable` output format — Vision-OCR'd invisible text layer behind each page (macOS/ICA).

### Foundation

- Renamed npm package to `@dougborg/scan-mcp`; MCP-registry identity `io.github.dougborg/scan-mcp` (CLI command and MCP server name stay `scan-mcp`).
- Promoted the fork to the default branch; preserved the pre-fork checkpoint as `upstream-tracking`.
- README rewrite (maintained-fork banner, backend support matrix), Dependabot, and a documented release flow.
